...
check(
    ...
    >= {
        ...
        "SIGNATURE BLOCK taken from the fenced block",
...
try:
    build("1. **PURPOSE:**\nfine\n\n```\nnot a signature\n```\n")
    check("STRICT_NO_CODE_BLOCKS raises", False)
except template_processor.ConversionError as e:
    check("STRICT_NO_CODE_BLOCKS raises ConversionError", "PURPOSE" in str(e), str(e))
