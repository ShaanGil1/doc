...
around. It runs 1. then a. then (1) then (a), and at the fifth level it starts
over rather than running out of markers. Note that a line of ordinary prose
must never begin with something like "1." because markdown reads that as the
start of a numbered list.

- This is level one and comes out as 1.
  - This is level two and comes out as a.
    - This is level three and comes out as (1).
      - This is level four and comes out as (a).
        - This is level five, where the cascade wraps back around to 1.
          - This is level six, which follows it back to a.
- This is a second item at level one, which continues the outer sequence at 2.
